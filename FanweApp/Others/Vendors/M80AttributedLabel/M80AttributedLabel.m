...
- (void)dealFace:(NSString*)str
{
    ...
    do
    {
        ...
        {//最好一次么有找到..
            [self appendText:[str substringWithRange:NSMakeRange(searchFrom.location, str.length - searchFrom.location)]];
            break;
        }
        ...
        [self appendText:[str substringWithRange:NSMakeRange(searchFrom.location, find.location - searchFrom.location)]];
        [self appendImage:[UIImage imageNamed:facename] maxSize:CGSizeMake(20, 20)];
