//
//  FWConversationListController.m
//  FanweApp
//
...
@interface FWConversationListController () <UITableViewDelegate, UITableViewDataSource>

@end

@implementation FWConversationListController
{
