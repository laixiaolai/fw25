...
@implementation NSObject (FWSwipeView)

- (CGSize)swipeViewItemSize:(__unused FWSwipeView *)swipeView { return CGSizeZero; }
- (void)swipeViewDidScroll:(__unused FWSwipeView *)swipeView {}
- (void)swipeViewCurrentItemIndexDidChange:(__unused FWSwipeView *)swipeView {}
- (void)swipeViewWillBeginDragging:(__unused FWSwipeView *)swipeView {}
- (void)swipeViewDidEndDragging:(__unused FWSwipeView *)swipeView willDecelerate:(__unused BOOL)decelerate {}
- (void)swipeViewWillBeginDecelerating:(__unused FWSwipeView *)swipeView {}
- (void)swipeViewDidEndDecelerating:(__unused FWSwipeView *)swipeView {}
- (void)swipeViewDidEndScrollingAnimation:(__unused FWSwipeView *)swipeView {}
- (BOOL)swipeView:(__unused FWSwipeView *)swipeView shouldSelectItemAtIndex:(__unused NSInteger)index { return YES; }
- (void)swipeView:(__unused FWSwipeView *)swipeView didSelectItemAtIndex:(__unused NSInteger)index {}

@end

@interface FWSwipeView () <UIScrollViewDelegate, UIGestureRecognizerDelegate>
...
- (void)setDataSource:(id<FWSwipeViewDataSource>)dataSource
{
...
- (void)setDelegate:(id<FWSwipeViewDelegate>)delegate
{
...
- (void)setAlignment:(FWSwipeViewAlignment)alignment
{
...
- (void)updateScrollViewDimensions
{
    ...
    switch (_alignment)
    {
        case FWSwipeViewAlignmentCenter:
        {
            if (_vertical)
            {
...
- (CGFloat)offsetForItemAtIndex:(NSInteger)index
{
    ...
    if (_wrapEnabled)
    {
        if (_alignment == FWSwipeViewAlignmentCenter)
        {
...
{
    //get number of items
    _numberOfItems = [_dataSource numberOfItemsInFWSwipeView:self];
